            ...
            <div class="container">
                <div class="header__inner">
                        ...
                        <div class="header__contact">
                            ...
                            <?php if ($social_icon) : ?>
                                <div class="header__fb">
                                    <a class="header__fb-link" target="_blank" href="<?php echo $social_link['url']; ?>">
                    ...
                    <div class="header__logo">
                        <?php
                        if ($logo_settings == 'light') : ?>
                            <a href="<?php echo get_home_url(); ?>" class="header__logo-link">
                                <?php echo file_get_contents($logo_1['url']) ?>
                            </a>
                        <?php endif; ?>
                        <?php
                        if ($logo_settings == 'dark') : ?>
                            <a href="<?php echo get_home_url(); ?>" class="header__logo-link">
                    ...
                    <div class="header__menu-btn">
                        <svg width="32" height="32" viewBox="0 0 32 33" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M7 10.5H25" stroke="#F0145A" stroke-width="2" />
                            <path d="M7 16.5H25" stroke="#F0145A" stroke-width="2" />
                            <path d="M7 22.5H25" stroke="#F0145A" stroke-width="2" />
                        </svg>
                    </div>
